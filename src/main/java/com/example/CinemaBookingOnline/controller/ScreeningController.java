...
public class ScreeningController {
    ...
    public List<ScreeningResponseDto> getScreeningByMovieId(@PathVariable Long movieId){
        return screeningService.getScreeningsByMovieId(movieId);
    }

    @GetMapping("/room/{roomId}")
    public List<ScreeningResponseDto> getScreeningByRoomId(@PathVariable Long roomId){
        return screeningService.getScreeningsByRoomId(roomId);
    }

    @GetMapping("/period")
    public List<ScreeningResponseDto> getScreeningByPeriod(@RequestParam LocalDate start, @RequestParam LocalDate end){
        return screeningService.getScreeningByPeriod(start, end);
    }

    @GetMapping("/period/query")
    public List<ScreeningResponseDto> getScreeningByPeriodQuery(@RequestParam LocalDate start, @RequestParam LocalDate end){
